...
export default function StatutesPage() {
  return (
    <>
      <PageHeader
        title="Statutes & Documents"
        description="Access our official governing documents that guide how ASAD operates with transparency and accountability."
      />
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center mb-12">
            <h2 className="text-2xl font-bold">Download Documents</h2>
            <p className="mt-4 text-muted-foreground">
              Access our official documents for detailed information about
              ASAD&apos;s governance and operations.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-muted-foreground">
              If you have questions about our statutes or need additional
              documentation, please contact our Secretary General. Members can
              request copies of official documents at any general assembly
              meeting.
            </p>
          </div>
        </div>
